		...
		/* <![CDATA[ */
			...
			function nuevaLineaFactura() {
				...
				$('#lineasFacturaTableBody').append('<tr>' +
                    ...
                    '<td class="tdBimp"><input type="text" onkeyup="this.value=this.value.explode(\'.\').join(\',\' )" onchange="recalculaTotalLinea(this)" class="lfactura_bimp" name="lfactura_bimp[]" value="0,00" /></td>' +
                		...
                		<table cellspacing="0">
                            ...
                            <thead>
            					...
            					<tr>
                            		...
                            		<td class="tdBimp"><input <?php echo $disabled ?> type="text" onkeyup="this.value=this.value.explode('.').join(',' )" onchange="recalculaTotalLinea(this)" class="lfactura_bimp" name="lfactura_bimp[]" value="<?php echo $lfactura->getLfacturaBimp() ?>" /></td>
